...
namespace Lean.Touch
{
	...
	[HelpURL(LeanTouch.PlusHelpUrlPrefix + "LeanManualScaleY")]
	[AddComponentMenu(LeanTouch.ComponentPathPrefix + "Manual ScaleY")]
	public class LeanManualScaleY : MonoBehaviour
	{
		...
		public void TranslateAB(Vector2 magnitude)
		{
			...
			Translate(directionB * magnitude.y);
		}
