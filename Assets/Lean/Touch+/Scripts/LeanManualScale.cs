...
namespace Lean.Touch
{
	...
	[HelpURL(LeanTouch.PlusHelpUrlPrefix + "LeanManualScale")]
	[AddComponentMenu(LeanTouch.ComponentPathPrefix + "Manual Scale")]
	public class LeanManualScale : MonoBehaviour
	{
